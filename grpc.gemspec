...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/ext/filters/client_channel/resolver/dns/c_ares/address_sorting_wrapper.h )
  ...
  s.files += %w( src/core/ext/filters/client_channel/resolver/dns/c_ares/address_sorting_wrapper.cc )
