...
test_runner_log('Run test: %s' % 'no-srv-ipv4-single-target.resolver-tests-version-4.grpctestingexp.')
...
test_runner_log('Run test: %s' % 'srv-ipv4-single-target.resolver-tests-version-4.grpctestingexp.')
current_test_subprocess = subprocess.Popen([
  args.test_bin_path,
  '--expected_lb_policy', '',
...
test_runner_log('Run test: %s' % 'srv-ipv4-multi-target.resolver-tests-version-4.grpctestingexp.')
current_test_subprocess = subprocess.Popen([
  args.test_bin_path,
  '--expected_lb_policy', '',
...
test_runner_log('Run test: %s' % 'srv-ipv6-single-target.resolver-tests-version-4.grpctestingexp.')
current_test_subprocess = subprocess.Popen([
  args.test_bin_path,
  '--expected_lb_policy', '',
...
test_runner_log('Run test: %s' % 'srv-ipv6-multi-target.resolver-tests-version-4.grpctestingexp.')
current_test_subprocess = subprocess.Popen([
  args.test_bin_path,
  '--expected_lb_policy', '',
...
test_runner_log('Run test: %s' % 'srv-ipv4-simple-service-config.resolver-tests-version-4.grpctestingexp.')
current_test_subprocess = subprocess.Popen([
  args.test_bin_path,
...
test_runner_log('Run test: %s' % 'ipv4-no-srv-simple-service-config.resolver-tests-version-4.grpctestingexp.')
current_test_subprocess = subprocess.Popen([
  args.test_bin_path,
  '--expected_lb_policy', 'round_robin',
...
test_runner_log('Run test: %s' % 'ipv4-no-config-for-cpp.resolver-tests-version-4.grpctestingexp.')
current_test_subprocess = subprocess.Popen([
  args.test_bin_path,
  '--expected_lb_policy', '',
...
test_runner_log('Run test: %s' % 'ipv4-cpp-config-has-zero-percentage.resolver-tests-version-4.grpctestingexp.')
current_test_subprocess = subprocess.Popen([
  args.test_bin_path,
  '--expected_lb_policy', '',
...
test_runner_log('Run test: %s' % 'ipv4-second-language-is-cpp.resolver-tests-version-4.grpctestingexp.')
current_test_subprocess = subprocess.Popen([
  args.test_bin_path,
  '--expected_lb_policy', 'round_robin',
...
test_runner_log('Run test: %s' % 'ipv4-config-with-percentages.resolver-tests-version-4.grpctestingexp.')
current_test_subprocess = subprocess.Popen([
  args.test_bin_path,
  '--expected_lb_policy', 'round_robin',
...
test_runner_log('Run test: %s' % 'srv-ipv4-target-has-backend-and-balancer.resolver-tests-version-4.grpctestingexp.')
current_test_subprocess = subprocess.Popen([
  args.test_bin_path,
  '--expected_lb_policy', '',
...
test_runner_log('Run test: %s' % 'srv-ipv6-target-has-backend-and-balancer.resolver-tests-version-4.grpctestingexp.')
current_test_subprocess = subprocess.Popen([
  args.test_bin_path,
  '--expected_lb_policy', '',
...
test_runner_log('Run test: %s' % 'ipv4-config-causing-fallback-to-tcp.resolver-tests-version-4.grpctestingexp.')
current_test_subprocess = subprocess.Popen([
  args.test_bin_path,
  '--expected_lb_policy', '',
...
test_runner_log('Run test: %s' % 'non-existant-name.test.com')
current_test_subprocess = subprocess.Popen([
  args.test_bin_path,
  '--expected_lb_policy', '',
  '--expected_chosen_service_config', '',
