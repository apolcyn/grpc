...
argp.add_argument('--records_config_path', default=None, type=str,
                  help=('Path to DNS records yaml file that '
                        'specified records for the DNS sever. '))
...
WIN_PYTHON = os.path.join('C:\\', 'Python27', 'python.exe')
# s = subprocess.Popen([WIN_PYTHON, '-c', 'test_runner_log("hello from sub")'])
# s.communicate()
