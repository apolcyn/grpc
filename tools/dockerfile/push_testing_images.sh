...
for DOCKERFILE_DIR in tools/dockerfile/test/* tools/dockerfile/grpc_artifact_* tools/dockerfile/interoptest/* tools/dockerfile/distribtest/* third_party/rake-compiler-dock tools/dockerfile/grpclb_interop_servers/*
do
  ...
  echo "docker push ${DOCKERHUB_ORGANIZATION}/${DOCKER_IMAGE_NAME}"
done
